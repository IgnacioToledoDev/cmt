      ...
      <Card className="mt-6 w-full lg:w-[85%] md:px-8" shadow={false}>
        <CardBody>
          ...
          <Typography variant="lead" color="black">
            <p>
              Soy especialista en Terapia de Pareja / Terapia de Parejas. <br />
              La creatividad y la colaboración son claves para resolver lo
              difícil de la vida. Por grave que parezca tu situación, colaboraré
              con la mejor versión de ti mismo(a) para que busquemos
              oportunidades para que las cosas comiencen a ser diferentes y
              ...
              lo primero que notarías distinto? Pareciera que el cambios se da
              en los pequeños detalles de la vida cotidiana, al alcance de todas
              las personas. ¿Te animas a descubrir tus posibilidades?
            </p>{" "}
